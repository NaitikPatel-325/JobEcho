  ...
  return (
    <div className="h-screen p-4 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      >
        ...
        <p className="text-sm text-gray-400">Discover your perfect educational journey</p>
      </motion.div>
      ...
      >
        <ResizablePanel defaultSize={35} minSize={30} className="p-3">
          <div className="mb-3 relative">
            <input
              ...
              className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/20"
            />
        ...
        <ResizablePanel defaultSize={65} className="p-4">
          {/* <div className="h-[calc(100vh-140px)] overflow-y-auto custom-scrollbar">
            <CollegeCard college={selectedCollege} isSelected={true} />
          </div> */}
          <InterviewExperience/>
        </ResizablePanel>
      </ResizablePanelGroup>
